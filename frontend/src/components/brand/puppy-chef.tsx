...
// The house mascot — direction A's storybook puppy chef (#mk-pup in
// planning/design-bakeoff/direction-a-midnight-kitchen.html), ported path-for-
// path: cream curly fur, tan floppy ears, pale-blue eyes with glints, ink
// outline, three-puff toque, both paws up with three claws each, wooden spoon
// in the right paw. Gradient ids are useId-scoped so instances never collide.
